...
var isContains = function isContains(array, obj) {
...
function upload(selector) {
  ...
  var changeHandler = function changeHandler(event) {
    ...
    var filesObj = event.target.files;
    var newFiles = Object.keys(filesObj).map(function (key) {
      return filesObj[key];
    });
    preview.innerHTML = '';
